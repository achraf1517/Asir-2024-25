...
Ejercicio 10:  
Cuál es el resultado de la ejecución de estas instrucciones?
 for($i=3;$i<=15;$i=$i+3):
echo "$i &nbsp;&nbsp;&nbsp;";
 endfor;
...
Ejercicio 11:  
Sabiendo que la instrucción  $i=$i+3;  es equivalente a la instrucción $i+=3;. 
¿Cuáles de estas opcines muestran como resultado de ejecución  3    6    9    12    15      
Opción a:   $i=3;
            while($i<=15):
            $i+=3;
            echo "$i &nbsp;&nbsp;&nbsp;";
